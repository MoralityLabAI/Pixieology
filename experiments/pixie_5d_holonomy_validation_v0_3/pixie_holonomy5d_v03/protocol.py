"""Configuration and hash primitives for the v0.3 continuation."""
...
def load_protocol(experiment_root: Path) -> dict[str, Any]:
    ...
    if value.get("schema") != "pixie_5d_holonomy_sharded_continuation_protocol_v3":
        raise ValueError("invalid v0.3 protocol schema")
    return value
