...
def _load_base(
    ...
    sharded = _runtime_path(
        repo_root,
        config,
        "pixie_etale_motif_sharded_model_root",
        "PIXIE_FEEDBACK_SHARDED_MODEL_ROOT",
    )
...
def train_feedback_job(
    ...
    output_root = _runtime_path(
        repo_root,
        config,
        "pixie_lora_feedback_v02_output_root",
        "PIXIE_FEEDBACK_OUTPUT_ROOT",
    )
