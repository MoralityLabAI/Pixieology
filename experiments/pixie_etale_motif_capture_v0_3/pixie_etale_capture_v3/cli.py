"""Command line for the versioned five-family continuation capture lane."""
...
from .capture import capture_continuation, finalize_execution
...
def main(argv: list[str] | None = None) -> int:
    ...
    if arguments.command == "capture":
        _print(capture_continuation(repo_root, experiment_root, arguments.authorization))
        return 0
