...
- `experiments/tegmark_mechinterp_observatory_v0_1/`: six-paper method-to-visualization observatory covering BIMT wiring, Clock/Pizza algorithm phases, hypernetwork phase maps, the MIPS compiler, sparse invariants, and goal-specific validation routes, with deterministic synthetic fixtures and agent-readable receipts.
